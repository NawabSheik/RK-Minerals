    ...
    <div className="industry-page">
      ...
      <div className="industry-section">
        ...
        <p className="industry-para">
          RK Minerals delivers high-quality minerals that enhance strength, whiteness, and thermal stability in ceramics.
          Our minerals improve workability, reduce shrinkage, and provide consistency in tile, tableware, sanitary ware,
          porcelain and insulator production.
        </p>
      ...
      <div className="industry-section2">
        ...
        <div className="industry-products-section">
          <div className="industry-products">
            <Link to="/products/china-clay" className="industry-products-card">
              ...
              <img src={ChinaClayImage} alt="China Clay" />
            </Link>
            ...
            <Link to="/products/talc" className="industry-products-card">
              ...
              <img src={TalcImage} alt="Talc Chips" />
            </Link>
            ...
            <Link to="/products/ball-clay" className="industry-products-card">
              ...
              <img src={BallClayImage} alt="Ball Clay" />
            </Link>
            ...
            <Link to="/products/levigated-clay" className="industry-products-card">
              ...
              <img src={LevigatedClayImage} alt="Levigated Clay" />
            </Link>
            ...
            <Link to="/products/wollastonite" className="industry-products-card">
              ...
              <img src={WollastoniteImage} alt="Wollastonite" />
            </Link>

            <Link to="/products/quartz" className="industry-products-card">
              <h2 className="product-name-ind">Quartz</h2>
              <div className="product-requirements">
                <h2 className="product-requirement">SiO₂: 98%+</h2>
                <h2 className="product-requirement">Low Fe₂O₃</h2>
                <h2 className="product-requirement">High Brightness</h2>
                <h2 className="product-requirement">Low Loss on Ignition</h2>
              </div>
        ...
        <p className="note-point">
          * Available in powder, lump, or chip form, these minerals improve strength, whiteness, thermal stability,
          and workability for ceramic production.
        </p>
      </div>
        ...
        <div className="excellence-cards">
          <div className="excellence-card">
            ...
            <p className="excellence-para">
              Every batch undergoes rigorous quality checks to ensure purity, consistency and dependable performance
          ...
          <div className="excellence-card">
            ...
            <p className="excellence-para">
              We work closely with ceramic manufacturers, understanding their requirements and delivering reliable
              mineral solutions on time.
            </p>
          </div>
          ...
          <div className="excellence-card">
            ...
            <p className="excellence-para">
              Our minerals are tailored to meet strength, whiteness, thermal stability and workability needs of ceramic
              production.
            </p>
          </div>
          ...
          <div className="excellence-card">
            ...
            <p className="excellence-para">
              We continuously improve mineral grades to help manufacturers create premium ceramic products with superior
