        ...
        <div className="industry-products-section">
          <div className="industry-products">
            <Link to="/products/china-clay" className="industry-products-card">
              ...
              <img src={ClayImage} alt="China Clay" />
            </Link>
            ...
            <Link to="/products/calcined-clay" className="industry-products-card">
              ...
              <img src={CalcinedClayImage} alt="Calcined Clay" />
            </Link>
        ...
        <div className="excellence-cards">
          <div className="excellence-card">
            ...
            <p className="excellence-para">
              ...
              brightness and consistency to ensure reliable paint performance.
            </p>
          </div>
          ...
          <div className="excellence-card">
            ...
            <p className="excellence-para">
              Our minerals enhance opacity, coverage, smoothness and durability
              across decorative and industrial coatings.
            </p>
          </div>
          ...
          <div className="excellence-card">
            ...
            <p className="excellence-para">
              We provide customized mineral grades to meet specific paint and
              coating formulation requirements.
            </p>
          </div>

          <div className="excellence-card">
            <h2 className="excellence-head">Innovation & Reliability</h2>
            <p className="excellence-para">
              Continuous product development and strict quality control help us
              deliver minerals that improve coating performance and longevity.
            </p>
          </div>
        </div>
      </div>
